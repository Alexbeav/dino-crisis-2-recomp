...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Dino Crisis 2",
    .project_root_env = "DINO_CRISIS_2_PROJECT_ROOT",
    .build_dir_env = "DINO_CRISIS_2_BUILD_DIR",
    .force_setup_env = "DINO_CRISIS_2_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLUS_012.79_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Dino_Crisis_2_Recompiled",
    .prepare_note =
